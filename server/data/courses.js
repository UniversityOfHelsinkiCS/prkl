...
function courseGenerator(title, deadline, code, description, teachers, questions, registrations) {
  return {
    id: uuidv4(),
    title: title,
    deadline: deadline,
...
// userData autogenerated users can be set in courses.js - if it's too high, cypress breaks
const regsForSingleAndMultipleChoiceCourse = userData.map(u => {
  ...
  return {
    id: regId,
    student: u,
    workingTimes: questionData.randomizedTimes(regId),
    questionAnswers: [
      {
        id: uuidv4(),
        registrationId: regId,
        questionId: questionData.defaultQuestions[0].id,
        answerChoices: questionData.defaultQuestions[0].questionChoices
          .sort(() => .5 - Math.random())
          .slice(0, Math.floor(Math.random() * questionData.defaultQuestions[0].questionChoices.length) + 1),
      },
      {
        id: uuidv4(),
        registrationId: regId,
        questionId: questionData.defaultQuestions[1].id,
        answerChoices: questionData.defaultQuestions[1].questionChoices
          .sort(() => .5 - Math.random())
          .slice(0, Math.floor(Math.random() * questionData.defaultQuestions[1].questionChoices.length) + 1),
      }
    ]
  };
});
...
const defaultCourses = [
  ...
  },
  {
    ...
    title: "Test Course for Single, Multiple, Times",
    ...
    questions: [
      ...
      questionData.defaultQuestions[1],
      questionData.defaultQuestions[2],
    ],
